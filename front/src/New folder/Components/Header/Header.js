...
const Header = () => {
    ...
    return(
        <>
            <header style={{width:'1893px', textWrap:'nowrap',}}>
                <div className='container-fluid'>
                    <div className='row'  style={{height:'83px', textWrap:'nowrap', display:'flex'}} >
                        <div className='col-sm-2' >
                            <img style={{width:"150px", height:'50px', marginLeft:'30px'}} alt='home' src={Logo} />
                        </div>
                        ...
                        <div className='col-sm-5 d-flex' style={{height:'70px', marginLeft:'65px'}}>
                                <div className='countryWrapper' style={{paddingBottom:'16px'}}>
